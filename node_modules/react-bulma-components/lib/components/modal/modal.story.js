...
function (_React$Component) {
  ...
  function OpenModal() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(OpenModal)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
_defineProperty(OpenModal, "propTypes", {
  modal: _propTypes["default"].object,
  children: _propTypes["default"].node.isRequired
});

_defineProperty(OpenModal, "defaultProps", {
  modal: {}
});
