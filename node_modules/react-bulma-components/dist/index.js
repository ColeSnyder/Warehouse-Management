...
var level_Level = function Level(_ref) {
  var children = _ref.children,
      className = _ref.className,
      breakpoint = _ref.breakpoint,
      props = level_objectWithoutProperties(_ref, ["children", "className", "breakpoint"]);

  return external_react_default.a.createElement(components_element, level_extends({}, props, {
    className: classnames_default()('level', className, level_defineProperty({}, "is-".concat(breakpoint), breakpoint))
  }), children);
};
...
function (_React$PureComponent) {
  ...
  function Pagination() {
    ...
    pagination_defineProperty(pagination_assertThisInitialized(_this), "firstPage", function (current, total) {
